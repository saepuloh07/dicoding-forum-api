...
DomainErrorTranslator._directories = {
  ...
  'DETAIL_THREAD.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError('tidak dapat menampilkan thread berdasarkan id karena properti yang dibutuhkan tidak ada'),
  'DETAIL_THREAD.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError('tidak dapat menampilkan thread berdasarkan id karena tipe data tidak sesuai'),
  ...
  'DETAIL_COMMENT.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError('tidak dapat menampilkan comment karena properti yang dibutuhkan tidak ada'),
  'DETAIL_COMMENT.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError('tidak dapat menampilkan comment karena tipe data tidak sesuai'),
  'DELETE_COMMENT_USE_CASE.NOT_CONTAIN_VALID_PAYLOAD': new InvariantError('tidak dapat menghapus comment karena properti yang dibutuhkan tidak ada'),
  ...
  'DELETE_REPLY_USE_CASE.NOT_CONTAIN_VALID_PAYLOAD': new InvariantError('tidak dapat menghapus reply karena properti yang dibutuhkan tidak ada'),
  'DELETE_REPLY_USE_CASE.PAYLOAD_NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError('tidak dapat menghapus reply karena tipe data tidak sesuai'),
  'ADD_USER_COMMENT_LIKES.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError('tidak dapat membuat comment likes baru karena properti yang dibutuhkan tidak ada'),
  'ADD_USER_COMMENT_LIKES.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError('tidak dapat membuat comment likes baru karena tipe data tidak sesuai'),
};
